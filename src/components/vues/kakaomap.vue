<template>
  <div>
    ...
    <div class="offcanvas offcanvas-start show" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
      ...
      <div>
        <div>
          <input type="submit" class="btn-check" name="option1" id="option1" autocomplete="off" checked />
          <label style="margin: 10px;" class="btn btn-warning" for="option1">한식</label>

          <input type="submit" class="btn-check" name="option2" id="option2" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option2">중식</label>

          <input type="submit" class="btn-check" name="option3" id="option3" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option3">양식</label>

          <input type="submit" class="btn-check" name="option4" id="option4" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option4">일식</label>
          <input type="submit" class="btn-check" name="option5" id="option5" autocomplete="off" />
        ...
        <!-- 2
        <div>
          <input type="submit" class="btn-check" name="options2" id="option6" autocomplete="off" checked />
          <label style="margin: 10px;" class="btn btn-warning" for="option6">술집</label>

          <input type="submit" class="btn-check" name="options2" id="option7" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option7">맛집</label>

          <input type="submit" class="btn-check" name="options2" id="option8" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option8">기념일</label>

          <input type="submit" class="btn-check" name="options2" id="option9" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option9">가성비</label>
          <input type="submit" class="btn-check" name="options2" id="option10" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option10">뷰</label>
        </div>
        <br /> -->
        <!-- 3 -->
        <div>
          <input type="submit" class="btn-check" name="options3" id="option11" autocomplete="off" checked />
          <label style="margin: 10px;" class="btn btn-warning" for="option11">가족</label>

          <input type="submit" class="btn-check" name="options3" id="option12" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option12">애견동반</label>

          <input type="submit" class="btn-check" name="options3" id="option13" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option13">색다른</label>

          <input type="submit" class="btn-check" name="options3" id="option14" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option14">청결</label>
          <input type="submit" class="btn-check" name="options3" id="option15" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option15">시끌벅적</label>
        </div>
        <br />
        <!-- 4 -->
        <div>
          <input type="submit" class="btn-check" name="options4" id="option16" autocomplete="off" checked />
          <label style="margin: 10px;" class="btn btn-warning" for="option16">한적</label>

          <input type="submit" class="btn-check" name="options4" id="option17" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option17">활동적</label>

          <input type="submit" class="btn-check" name="options4" id="option18" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option18">고급스런</label>

          <input type="submit" class="btn-check" name="options4" id="option19" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option19">감성적</label>
          <input type="submit" class="btn-check" name="options4" id="option20" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option20">이국적</label>
        </div>
        <br />
        <!-- 5 -->
        <div>
          <input type="submit" class="btn-check" name="options5" id="option21" autocomplete="off" checked />
          <label style="margin: 10px;" class="btn btn-warning" for="option21">편리한</label>

          <input type="submit" class="btn-check" name="options5" id="option22" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option22">전통적</label>

          <input type="submit" class="btn-check" name="options5" id="option23" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option23">모던한</label>

          <input type="submit" class="btn-check" name="options5" id="option24" autocomplete="off" />
          <label style="margin: 10px;" class="btn btn-warning" for="option24">편안한</label>
          <input type="submit" class="btn-check" name="options5" id="option25" autocomplete="off" />
